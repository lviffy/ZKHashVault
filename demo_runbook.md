# ZKHashVault MVP Demo Runbook

## Overview
This runbook demonstrates the full lifecycle of the ZKHashVault smart yield optimizer running on the **Hashkey Testnet** (Chain ID: 133). 

1. User deposits standard yield-bearing testnet tokens into the intelligent `ZKHashVault` contract.
...
*   **Contract Deployment (ZKHashVault):** `0xEC4A4d4c41C09814f7878A71c58D35637f9FecD6`
